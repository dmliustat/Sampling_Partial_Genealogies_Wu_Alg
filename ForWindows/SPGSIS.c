...
int main(int argc, char *argv[]){
    ...
    else fopen_s(&in1, "C:\\Users\\blabl\\Desktop\\git repos\\sampling_partial_genealogies_infinite_sites_model\\input_files\\tree_Oct_infile1","r");
    ...
    else fopen_s(&in2, "C:\\Users\\blabl\\Desktop\\git repos\\sampling_partial_genealogies_infinite_sites_model\\input_files\\tree_Oct_infile2","r");
    ...
    if(argc>3){
        ...
        snprintf(filename, 200, "C:\\Users\\blabl\\Desktop\\git repos\\sampling_partial_genealogies_infinite_sites_model\\input_files\\out_wt.txt");
        fopen_s(&out, filename, "w");
    }
    if(out){
    ...
    while (flag) {
        if (fgets(string, sizeof(string), infile) == NULL) {
            ...
            case'F':
                ...
                /*for (j = 0; j < 2; j++) {
                    if (fscanf_s(infile, "%ld", &seed[j]) != 1) {
                ...
                fprintf(stderr, "\n");*/
                sscanf_s(string + i, "%ld", &seed[0]);
                fprintf(stderr, "%ld ", seed[0]);
                while (string[i] != ',') i++;
                i++;
                sscanf_s(string + i, "%ld", &seed[1]);
                fprintf(stderr, "%ld\n", seed[1]);
                break;
