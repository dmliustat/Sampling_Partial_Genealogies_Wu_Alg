...
int main(int argc, char *argv[]){
    ...
    FILE *in1, *in2, *out, *seed_file, *seed_file_w;
    ...
    else fopen_s(&in1, "C:\\Users\\blabl\\Desktop\\git repos\\sampling_partial_genealogies_infinite_sites_model\\input_files\\tree1_infile1","r");
    ...
    else fopen_s(&in2, "C:\\Users\\blabl\\Desktop\\git repos\\sampling_partial_genealogies_infinite_sites_model\\input_files\\tree1_infile2","r");
    ...
    if(argc>3){
        ...
        snprintf(filename, 200, "C:\\Users\\blabl\\Dropbox\\output\\out_2stage.txt");
        fopen_s(&out, filename, "w");
    }
    if(out){
